...
| **Prikupljanje stvarno ide na 2–3 sata, iako cron traži 20 minuta** | GitHub Actions raspored na besplatnom tier-u je „najbolji pokušaj", bez ikakve garancije. | Jeftin server sa pravim cron-om (Hetzner ili sličan VPS, oko **$5/mesec**) daje tačan ritam i od 5 minuta. **Po odnosu uloženog i dobijenog, ovo je najisplativija nadogradnja u celom spisku.** | 📏 Izmereno 7.9.2026 iz istorije pokretanja: traženo 20 minuta, stvarni razmaci **119, 128 i 177 minuta**. Vest prosečno čeka **oko dva sata** pre nego što uđe u sistem. |
| **Tajne u GitHub Secrets, bez provere pri pokretanju** | Besplatno i standardno. | Provera na početku posla („jesu li svi ključevi tu") — **$0**, samo posao; sada je i dodata. | 📏 Izmereno 7.9.2026: dva zakazana ciklusa pisanja članaka pala su jer `ANTHROPIC_API_KEY` nije bio među secrets-ima. GitHub nepostojeći secret širi u **prazan string**, pa se greška vidi tek kad model odbije poziv. |
...
| **Slike se crtaju kodom, ne generišu AI-jem** | Nula troška po slici i nema pravnog rizika oko prikazivanja stvarnih ličnosti. | Generisanje slika modelom: 📐 procena **oko $0.04 po slici**, dakle oko $12 mesečno pri 10 članaka dnevno — uz pravni rizik koji brief izričito zabranjuje za imenovane osobe. | 📏 Izmereno (Faza 8): 18 šablona, 0,25 s i 45 KB po slici, $0 po slici. Da li čitaoca odbija slika bez fotografije — ❓ nepoznato, nije testirano. |
| **Nijedna slika nema fotografiju** | Fotoagencijski materijal se plaća, a preuzimanje tuđih fotografija je kršenje autorskog prava. | Licenca fotoagencije: Tanjug i Beta prodaju pakete, cena se dogovara po ugovoru — 📐 procena reda veličine **od nekoliko stotina evra mesečno**. Getty/AP su skuplji. | ❓ Nepoznato koliko tačno košta za mali sajt; nisu traženi uslovi. Uticaj na posećenost — ❓ nepoznato. |
| **Slike stoje u Supabase Storage besplatnom tier-u (1 GB)** | Besplatno i već postoji uz bazu. | Plaćeni Supabase je $25 mesečno za 100 GB. | 📏 Izmereno: 45 KB po slici, 10 članaka dnevno = 1 GB tek posle šest godina. Ovo neće biti razlog za plaćanje. |
...
| 4 | **Jeftin server sa pravim cron-om** | ~$5/mesec | Prikupljanje na 5 minuta umesto stvarnih 2–3 sata. Ovo bi trebalo kupiti **prvo**, pre svega ostalog na ovom nivou. | 📏 Izmereno 7.9.2026: stvarni razmaci 119–177 minuta naspram traženih 20. |
